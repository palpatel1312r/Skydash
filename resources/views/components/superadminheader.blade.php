    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                @php
                    $dashboardUrl = route('Superadmin.Superadmin_Dashboard');
                @endphp
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    {{-- 1. DASHBOARD --}}
                    @php
                        $isDashboardActive = request()->routeIs('Superadmin.Superadmin_Dashboard');
                    @endphp
                    <li class="nav-item {{ $isDashboardActive ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('Superadmin.Superadmin_Dashboard') }}">
